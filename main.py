...
extensions = ['cogs.help', 'cogs.emergency',
              'cogs.owner',
              'cogs.default',
              'cogs.error_handler']
...
async def on_ready():
    try:
        await bot.change_presence(activity=discord.Game(name='?cmds', type=0))
    except:
        await bot.change_presence(game=discord.Game(name='?cmds', type=0))
